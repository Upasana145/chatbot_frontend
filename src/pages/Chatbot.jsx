...
//           <div
//             className="chatbox"
//           // className={`chatbox ${isChatboxFullscreen ? "fullscreen" : isChatboxMinimized ? "minimized" : ""
//           // }`}
//           >
//             <header>
//               <h3>ChatBot</h3>
...
//                 <button onClick={toggleFullscreen}>{isChatboxFullscreen ? "⤡" : "⬍"}</button>
...
//             <div className="chat">
//               <div className="chat-message user">Hi! I'm Umi 🤖</div>
//               <div className="chat-message user">
//                 I've moved and I'd like to update my address. How can I do that?
//               </div>
//               <div className="chat-message bot">
//                 Hi Robert, you can update both your shipping and billing address by
//           clicking Account Settings > Personal Details and editing the Address
//                 field.
//               </div>
//             </div>
